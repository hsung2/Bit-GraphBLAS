...
double evalHSBSFBmv()
{
    ...
    {
#if TILEDIM == 4
        bmv4_bin_bin_full<<<grid, 32>>>(tA, tB, fC, bsrRowPtr, bsrColInd, nblockrows);
#elif TILEDIM == 8
        bmv8_bin_bin_full<<<grid, 32>>>(tA, tB, fC, bsrRowPtr, bsrColInd, nblockrows);
#elif TILEDIM == 16
        bmv16_bin_bin_full<<<grid, 32>>>(tA, tB, fC, bsrRowPtr, bsrColInd, nblockrows);
#elif TILEDIM == 32
        bmv32_bin_bin_full<<<grid, 32>>>(tA, tB, fC, bsrRowPtr, bsrColInd, nblockrows);
#endif
    }
